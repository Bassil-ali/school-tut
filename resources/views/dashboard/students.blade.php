...
@endif
                    ...
                    <div class="row">
                        ...
                        <div class="card" style="padding: 20px;">
                            <div class="row">
                        <div class="col-3">
                                        <button type="button" class="btn btn-success waves-effect waves-float waves-light"><a style="color:#fff" href="{{route('admin_students.create')}}">اضافة طالب جديد</a></button>
                                        </div></div><br>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-success waves-effect waves-float waves-light"
                                                href="{{route('admin_students.edit', $student->id)}}"
                                                 title="حذف"><i
                                                    class="las la-edit"></i>تعديل</a>
                                             <button type="button" class="btn btn-secondary waves-effect waves-float waves-light"><a style="color:#fff" href="{{url('report', $student->id)}}"">تقرير الطالب</a></button>
...
<div class="modal" id="modaldemo9">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            ...
            <form action="admin_students/destroy" method="post">
                {{ method_field('delete') }}
                {{ csrf_field() }}
